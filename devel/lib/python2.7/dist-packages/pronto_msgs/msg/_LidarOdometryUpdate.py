...
"""autogenerated by genpy from pronto_msgs/LidarOdometryUpdate.msg. Do not edit."""
import codecs
import sys
...
class LidarOdometryUpdate(genpy.Message):
  _md5sum = "f571239a848b48578d24ae00902925c8"
  _type = "pronto_msgs/LidarOdometryUpdate"
...
float64 w
"""
  __slots__ = ['header','curr_timestamp','prev_timestamp','relative_transform','covariance']
  _slot_types = ['std_msgs/Header','time','time','geometry_msgs/Transform','float64[36]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,curr_timestamp,prev_timestamp,relative_transform,covariance
    ...
    """
    if args or kwds:
      super(LidarOdometryUpdate, self).__init__(*args, **kwds)
