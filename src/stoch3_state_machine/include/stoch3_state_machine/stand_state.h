...
class StandState : public State
{
  ...
  public:
    ...
    void init(std::string prev_state)
    {
      ...
      switch_high_level_controller.request.name = "stand_controller";
    ...
    void exit(std::string next_state)
    {
      ...
      if(next_state != "Hold")
      {
        // Wait until the stand action is complete
        ...
        do
        {
          ...
          ROS_INFO("Waiting for Stand controller to complete execution.");
        }
