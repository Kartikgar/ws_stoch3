...
class JointStateWithAcceleration {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type JointStateWithAcceleration
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type JointStateWithAcceleration
    let len;
    let data = new JointStateWithAcceleration(null);
  ...
  static datatype() {
    ...
    return 'pronto_msgs/JointStateWithAcceleration';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JointStateWithAcceleration(null);
...
module.exports = JointStateWithAcceleration;
