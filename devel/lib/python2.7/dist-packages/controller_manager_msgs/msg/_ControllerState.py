...
class ControllerState(genpy.Message):
  _md5sum = "3c589ea9c9f0ad05be56a20f9f6d64f1"
...
string[] resources
"""
  __slots__ = ['name','state','type','priority','claimed_resources']
  _slot_types = ['string','string','string','int32','controller_manager_msgs/HardwareInterfaceResources[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,state,type,priority,claimed_resources
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.hardware_interface = str[start:end].decode('utf-8', 'rosmsg')
        else:
