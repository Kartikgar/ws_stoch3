...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ListControllers-request>)))
  ...
  "943fb5d3bbc209623c0202d4e174627a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ListControllers-request)))
  "Returns md5sum for a message object of type 'ListControllers-request"
  "943fb5d3bbc209623c0202d4e174627a")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ListControllers-response>)))
  ...
  (cl:format cl:nil "ControllerState[] controller~%~%~%================================================================================~%MSG: controller_manager_msgs/ControllerState~%string name~%string state~%string type~%int32 priority~%controller_manager_msgs/HardwareInterfaceResources[] claimed_resources~%~%================================================================================~%MSG: controller_manager_msgs/HardwareInterfaceResources~%# Type of hardware interface~%string hardware_interface~%# List of resources belonging to the hardware interface~%string[] resources~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ListControllers-response)))
  "Returns full string definition for message of type 'ListControllers-response"
  (cl:format cl:nil "ControllerState[] controller~%~%~%================================================================================~%MSG: controller_manager_msgs/ControllerState~%string name~%string state~%string type~%int32 priority~%controller_manager_msgs/HardwareInterfaceResources[] claimed_resources~%~%================================================================================~%MSG: controller_manager_msgs/HardwareInterfaceResources~%# Type of hardware interface~%string hardware_interface~%# List of resources belonging to the hardware interface~%string[] resources~%~%~%"))
